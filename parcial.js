...
let productos = [
  {
    ...
    nombre: 'Razer blade',
    descripcion:
      'Razer Blade 16: Un portátil gaming potente y elegante con una pantalla de 16 pulgadas para una experiencia de juego envolvente.',
    precio: 500,
    imagen: 'fotos/Productos/razer-blade-1.jpg',
    alt: 'Iphone 12',
    categoría: 'Celulares',
  },
  {
    ...
    descripcion:
      'Razer Keyboard BlackWidow: Teclado mecánico gaming con retroiluminación y teclas programables para ofrecer precisión y comodidad a los jugadores.',
    precio: 1000,
    imagen: 'fotos/Productos/teclado-1.jpeg',
    alt: 'Macbook air',
    categoría: 'Laptop',
  },
  {
    id: 3,
    nombre: 'Razer DeathAdder',
    descripcion:
      'Razer DeathAdder: Ratón ergonómico de alta precisión diseñado para juegos, con un sensor óptico preciso y botones programables para una experiencia de juego ágil y receptiva.o',
    precio: 200,
    imagen: 'fotos/Productos/mouse-1.jpg',
    alt: 'Airpods 3',
  ...
  },
  {
    ...
    precio: 1500,
    imagen: 'fotos/Productos/razer-blade-2.jpg',
  ...
  },
  {
    ...
    descripcion: 'Descripción del producto',
    precio: 2000,
    imagen: 'fotos/Productos/teclado-2.webp',
    alt: 'Macbook pro',
    categoría: 'Laptops',
  },
  {
    ...
    descripcion: 'Descripción del producto',
    precio: 400,
    imagen: 'fotos/Productos/mouse-2.jpeg',
    alt: 'Apple Watch',
    categoría: 'Accesorios',
  },
];
...
for (let i = 0; i < 6; i++) {
  ...
  let parrafos3 = crearEtiqueta('p', {}, productos[i].categoría);
